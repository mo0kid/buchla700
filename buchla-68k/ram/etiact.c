...
int16_t ef_iact(int16_t nn)
{
	register int16_t i, tmp1, tmp2;
	register struct instpnt *pp;
...
int16_t rd_iact(int16_t nn)
{
	register int16_t pnt, par, n;
	register struct instpnt *pp;
	register int8_t *s1;
...
int16_t nd_iact(int16_t nn, int16_t k)
{
	register int16_t n, ec;
