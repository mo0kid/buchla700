...
struct s_entry *ep_adj(struct s_entry *sep, int16_t sdir, int32_t tval)
{
...
struct s_entry *frfind(int32_t tval, int16_t sdir)
{
	register int16_t	i;
	register int32_t	t_min, dt;
...
struct s_entry *findev(struct s_entry *ep, int32_t te, int16_t et, int16_t d1, int16_t d2)
{
...
struct s_entry *ehfind(int16_t eh, int32_t te, int16_t d1, int16_t d2)
{
	register struct s_entry *tp;
