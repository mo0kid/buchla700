...
int16_t	dsdecol[5][2][2] =  {	/* destination data entry column table */
...
int16_t	des2fmt[] = {		/* destination type to data entry format */
...
int16_t	dtabl7[] = { 11, 1, 2, 3, 10 };		/* aux datum format table */

int16_t	dtabl9[] = { 11, 1, 2, 3, 9 };		/* FPU datum format table */
...
void ptde_ds(int16_t n, int16_t key)
{
	register int16_t chan, port, stim;
	int8_t buf[8], buf2[8];
