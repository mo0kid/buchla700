...
int16_t	DB_In;				/* debug buffer 'in' pointer */
int16_t	DB_Out;				/* debug buffer 'out' pointer */
int16_t	DB_Flag;			/* ROMP trap disable flag */

int32_t	DB_Levl;			/* debug function call level */

int8_t	*DB_Last;			/* last debug string pointer */

static	struct	DB_Data	DB_Ents[DB_DEPTH];
					/* debug buffer */

int8_t	*DB_Type[] = {			/* debug buffer entry types */
...
void DB_Dump(void)
{
	register int16_t tag;
	register int32_t i, lev;
