...
int16_t loc2key(int16_t row, int16_t col)
{
	if (row EQ 24) {
...
int16_t rd_tpch(int16_t nn)
{
	register int16_t val, key, n;
...
int16_t nd_tpch(int16_t nn, int16_t k)
{
	register int16_t col, n;
