...
int16_t	notetab[] = { 0, 2, 3, 5, 7, 8, 10 };
int16_t	octab[]   = { 21, 33, 45, 57, 69, 81, 93, 105 };
...
int16_t Pcheck(struct s_entry *ptr, int8_t *msg)
{
...
struct n_entry *insnevt(struct n_entry *nsp, int16_t nt, int16_t grp, int16_t note, int16_t vel)
{
	nsp->e_time  = t_cur;
