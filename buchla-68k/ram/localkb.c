...
int16_t	panlkey[24] = {		/* default tunings, in cents, for local keys */
...
int16_t	stepfrm[4][17] = {	/* step mode frame counts */
...
void localkb(int16_t sig)
{
	register int16_t i, trg, lclkey, key, vel;
