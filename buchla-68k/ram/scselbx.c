...
int8_t	*sdmenus[][3] = {	/* score display menus */
...
int16_t	sdmht[][3] = {		/* score section menu highlight table */
...
int16_t	sdmlim[][4] = {		/* score display menu cursor limits */
...
int8_t	*nedlbl[] = {		/* note edit function labels */
...
void dsgtmn(int16_t n, int16_t f)
{
	int8_t buf[4];
	uint16_t atr;
	int16_t col;
...
void showam(int16_t asg)
{
	register int16_t col, na, row;
...
void hilitop(int16_t n)
{
	register int16_t row, lc, rc, col;
