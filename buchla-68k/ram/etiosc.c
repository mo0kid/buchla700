...
/*		        A     B     C     D     E     F     G	*/
int16_t	pitches[] = { 900, 1100,    0,  200,  400,  500,  700};
...
static	int8_t	ratstr[] = "1/1";
static	int8_t	frqstr[] = "00.0";
static	int8_t	pchstr[] = "0C 00";

int16_t	ndvals[10] = {0, 0, 1200, 1902, 2400, 2786, 3102, 3369, 3600, 3804};
...
void int2rat(int16_t rat)
{
	register int16_t den, inum, num;
...
void cnvc2p(int8_t *buf, int16_t cv)
{
	int16_t	rem, tmp;
...
int16_t et_iosc(int16_t nn)
{
	register struct instdef *ip;
	register int16_t val, ctl, fh, fl, v;
...
void setoval(struct instdef *ip, int16_t v, int16_t val)
{
	switch (v) {
...
int16_t ef_iosc(int16_t nn)
{
	register struct instdef *ip;
	register int16_t v, i, tmp;
...
void setoscb(int16_t n, int16_t v)
{
	register struct instdef *ip;
	register int16_t bfm, ctl, val;
	register int8_t ocs;
...
void setosyn(int16_t n, int16_t v, int16_t t)
{
	register struct instdef *ip;
	register int8_t *sc;
...
int16_t nd_iosc(int16_t nn, int16_t k)
{
	register int16_t v, n;
