...
int16_t	zoneinc[9] = {  2,   2,   4,   9,  18,  36,  73, 146, 303};
...
struct	fet	id_fet1[] = {
	...
	{18, 36, 46, (int16_t)0x8014, et_iosc, ef_iosc, rd_iosc, nd_iosc},
	{18, 17, 32,               0, et_null, ef_null, rd_null, nd_null},
	{19, 36, 46, (int16_t)0x8114, et_iosc, ef_iosc, rd_iosc, nd_iosc},
	{19, 17, 32,               0, et_null, ef_null, rd_null, nd_null},
	{20, 36, 46, (int16_t)0x8214, et_iosc, ef_iosc, rd_iosc, nd_iosc},
	{20, 17, 32,               0, et_null, ef_null, rd_null, nd_null},
	{21, 36, 46, (int16_t)0x8314, et_iosc, ef_iosc, rd_iosc, nd_iosc},
	{21, 17, 32,               0, et_null, ef_null, rd_null, nd_null},

	{ 0,  0,  0, 0x0000, FN_NULL, FN_NULL, FN_NULL, FN_NULL}
};

int8_t	*srctbl[] = {		/* source label table */
...
void idcxupd(void)
{
	register uint16_t th, tl;
	register uint16_t fptime, stime;
	int16_t zone;
...
{
	register int16_t endpnt, basepnt, t, fn;
