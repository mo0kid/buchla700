/* gdate.c -- get date -- Version 1 -- 1986-01-09 */
/* requires the "notorious" timeb.h and ftime() */
 ...
 *
 *	if you compile it with DEBUG defined it will
...
register struct tm *tp ;
{
	...
	if((days(tp->tm_year) == 366) && (tp->tm_mon > 2))
		++ret ;
